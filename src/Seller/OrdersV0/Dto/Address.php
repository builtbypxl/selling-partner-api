...
final class Address extends BaseDto
{
	 ...
	 * @param ?AddressExtendedFields $extendedFields The container for address extended fields. For example, street name or street number. Only available for Brazil shipping addresses as of now.

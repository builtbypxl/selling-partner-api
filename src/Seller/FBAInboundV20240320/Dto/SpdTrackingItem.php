...
final class SpdTrackingItem extends BaseDto
{
	/**
	 ...
	 * @param ?string $trackingNumberValidationStatus Whether or not Amazon has validated the tracking number. If more than 24 hours have passed and the status is
